...
export function ProductCard({ product }) {
    ...
    return (
        <div
            className="group relative bg-white dark:bg-zinc-800/50 backdrop-blur-md border border-gray-200 dark:border-white/10 p-5 rounded-2xl transition-all duration-300 hover:bg-gray-50 dark:hover:bg-zinc-800/80 hover:scale-[1.02] hover:shadow-xl hover:shadow-indigo-500/10 cursor-pointer overflow-hidden animate-fade-in"
            onClick={() => {
